...
public class ItemEtheriumSpade extends ItemSpade implements IEtheriumTool {

    public ItemEtheriumSpade() {
        super(EnigmaticLegacy.ETHERIUM);
        setTranslationKey("etherium_spade");
        setRegistryName(new ResourceLocation(EnigmaticLegacy.MODID, "etherium_spade"));
    ...
    public void addInformation(ItemStack stack, @Nullable World worldIn, List<String> list, ITooltipFlag flagIn) {
        if (GuiScreen.isShiftKeyDown()) {
            list.add(TextFormatting.GOLD + I18n.format("tooltip.enigmaticlegacy.etheriumShovel1"));
            list.add("");

            list.add(I18n.format("tooltip.enigmaticlegacy.etheriumShovel2"));

            list.add(I18n.format("tooltip.enigmaticlegacy.etheriumShovel3"));
        } else {
