...
import keletu.enigmaticlegacy.packet.PacketPlayQuote;
...
public class Quote {
    ...
    public void playOnceIfUnlocked(EntityPlayerMP player, int delayTicks) {
    ...
    public void playOnceIfUnlocked(EntityPlayerMP player) {
        this.playOnceIfUnlocked(player, 1);
    }

    public void playIfUnlocked(EntityPlayerMP player) {
        this.play(player);
    }

    public void playIfUnlocked(EntityPlayerMP player, int delayTicks) {
        this.play(player, delayTicks);
    }

    public void playWithoutLimit(EntityPlayerMP player, int delayTicks) {
        EnigmaticLegacy.packetInstance.sendTo(new PacketPlayQuote(this, delayTicks), player);
    }

    public void play(EntityPlayerMP player, int delayTicks) {
        if (BaublesApi.isBaubleEquipped(player, EnigmaticLegacy.enigmaticEye) == -1)
            return;
    ...
    public void play(EntityPlayerMP player) {
        this.play(player, 1);
    }
