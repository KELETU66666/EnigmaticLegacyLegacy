...
public class EnigmaticRelicsContainer extends ItemStackHandler implements IRelicsItemHandler {
	...
	public EnigmaticRelicsContainer()
	{
		super(BAUBLE_SLOTS);
	}
	...
	public boolean isItemValidForSlot(int slot, ItemStack stack, EntityLivingBase player) {
		if (stack==null || stack.isEmpty() || !stack.hasCapability(EnigmaticCapabilities.CAPABILITY_ITEM_RELIC, null))
			return false;
		IEnigmaticRelic bauble = stack.getCapability(EnigmaticCapabilities.CAPABILITY_ITEM_RELIC, null);
		return bauble.canEquip(stack, player) && bauble.getSlot(stack).hasSlot(slot);
	}
