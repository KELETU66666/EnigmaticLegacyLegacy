...
public class GuiPlayerButton extends GuiButton {
	...
	public GuiPlayerButton(int buttonId, GuiContainer parentGui, int x, int y, int width, int height) {
		super(buttonId, x, parentGui.getGuiTop() + y, width, height, "button.normal");
	...
	public boolean mousePressed(Minecraft mc, int mouseX, int mouseY) {
		...
		if (pressed) {
			if (parentGui instanceof GuiExtraBaubles) {
				((GuiExtraBaubles) parentGui).displayNormalInventory();
