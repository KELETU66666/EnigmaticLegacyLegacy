...
public class ContainerExtraBaubles extends Container {
    ...
    public ContainerExtraBaubles(InventoryPlayer playerInv, boolean par2, EntityPlayer player) {
        ...
        this.addSlotToContainer(new SlotBauble(player, baubles, 3, 78, 44));
        this.addSlotToContainer(new SlotBauble(player, baubles, 4, 60, 98));
        this.addSlotToContainer(new SlotBauble(player, baubles, 5, 78, 80));
        this.addSlotToContainer(new SlotBauble(player, baubles, 6, 60, 8));
